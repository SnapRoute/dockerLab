...
To start the lab, enter into the dockerLab folder created during [docker lab install](https://github.com/SnapRoute/dockerLab/README.md) and execute the **labtool.py** script with --lab argument **lab1**
